...
const { ClinicSchema, NeedSchema, AddressNodeSchema, NeedTypeSchema } = require('./schema');
...
keystone.createList('NeedType', NeedTypeSchema);
keystone.createList('Need', NeedSchema);
